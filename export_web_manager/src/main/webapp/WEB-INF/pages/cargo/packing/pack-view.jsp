...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">当前是【${exportNos}】合同的装箱单信息</div>
            <div class="row data-type" style="margin: 0px">
                ...
                <div class="col-md-4 data">
                    <div class="input-group date">
                        ...
                        <input type="text" placeholder="装箱时间" readonly="readonly" name="packingTime" class="form-control pull-right"
                ...
                <div class="col-md-4 data">
                    <input type="text" readonly="readonly" class="form-control" placeholder="唛头" name="marks" value="${packing.marks}"/>
                </div>

                <div class="col-md-2 title">描述</div>
                <div class="col-md-4 data">
                    <input type="text" readonly="readonly" name="description" class="form-control" placeholder="描述" value="${packing.description}"/>
                </div>
