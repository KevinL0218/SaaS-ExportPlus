                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="发票时间"  name="signingDate" class="form-control pull-right"
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="报运合同号*" name="contractNo" value="${contract.contractNo}">
                    </div>

                    <div class="col-md-2 title">贸易条款</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="贸易条款*" name="offeror" value="${contract.offeror}">
                    </div>

                    <div class="col-md-2 title">发票金额</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="自动计算(报运金额+装箱金额+委托金额)*" name="inputBy" value="${contract.inputBy}">
                    </div>
